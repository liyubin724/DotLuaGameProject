...
namespace DotEngine.Assets
{
    ...
    {
        private ElementPool<BundleAsyncOperation> bundleOperationPool = new ElementPool<BundleAsyncOperation>();
        private ElementPool<BundleAssetAsyncOperation> assetOperationPool = new ElementPool<BundleAssetAsyncOperation>();
        private ElementPool<BundleNode> bundleNodePool = new ElementPool<BundleNode>();
