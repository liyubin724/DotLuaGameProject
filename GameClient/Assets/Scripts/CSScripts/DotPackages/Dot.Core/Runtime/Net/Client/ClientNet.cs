...
namespace DotEngine.Net.Client
{
    ...
    public partial class ClientNet //: IDispose
    {
        ...
        {
            DebugLog.Error(NetConst.CLIENT_LOGGER_TAG, $"ClientNet::OnMessageError->message error.code = {code}");
            Dispose();
        }
        ...
        private void OnMessageReceived(int messageID, byte[] datas)
        {
            ...
            DebugLog.Error(NetConst.CLIENT_LOGGER_TAG, $"ClientNet::OnMessageReceived->the handler not found.messageID = {messageID}");
        }
        ...
        public void RegisterMessageHandler(string name, IClientNetMessageHandler handler)
        {
            ...
            {
                DebugLog.Error(NetConst.CLIENT_LOGGER_TAG, $"ClientNet::RegisterMessageHandler->the handler has been added.name={name}");
            }
        }
        ...
        public void UnregisterMessageHandler(string name)
        {
            ...
            {
                DebugLog.Error(NetConst.CLIENT_LOGGER_TAG, $"ClientNet::UnregisterMessageHandler->The handler not found.name={name}");
            }
        }
