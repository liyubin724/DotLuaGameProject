    ...
    public class AssetAddressConfig : ScriptableObject,ISerializationCallbackReceiver
    {
        ...
        public void OnAfterDeserialize()
        {
            foreach (var data in addressDatas)
            {
                ...
                {
                    DebugLog.Error(typeof(AssetAddressConfig).Name, $"The address is repeated. address = {data.assetAddress}");
                    continue;
                }
                else
                {
                ...
                {
                    DebugLog.Error(typeof(AssetAddressConfig).Name, $"The path is repeated. path = {data.assetPath}");
                    continue;
                }
                else
                {
