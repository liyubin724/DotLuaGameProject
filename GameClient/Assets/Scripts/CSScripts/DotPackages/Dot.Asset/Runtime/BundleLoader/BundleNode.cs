    ...
    public class BundleNode : IObjectPoolItem
    {
        ...
        internal bool IsScene
        {
            get 
            {
                ...
                {
                    DebugLog.Error(AssetConst.LOGGER_NAME,"BundleNode::IsScene->AssetBundle has not been loaded,you should call IsDone at first");
                }
                else
                {
                    DebugLog.Error(AssetConst.LOGGER_NAME, "BundleNode::IsScene->AssetBundle Load failed");
                }
                return false;
            }
        }
