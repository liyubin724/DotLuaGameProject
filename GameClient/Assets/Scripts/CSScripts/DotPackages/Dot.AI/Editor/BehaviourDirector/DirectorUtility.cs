...
//                    where type.IsSubclassOf(typeof(DotEngine.AI.BD.Actions.ActionData))
...
//                        {
//                            callback?.Invoke((DotEngine.AI.BD.Actions.ActionData)(DotEngine.AI.BD.Actions.ActionData)Activator.CreateInstance((Type)type));
//                        });
//                    }
//                }
//            }
...
//        public static void ShowActionConditionMenu(Action<ConditionData> callback)
//        {
//            if(sm_ConditionTypes == null)
//            {
//                sm_ConditionTypes = (from type in sm_NodeTypes
//                                     where type.IsSubclassOf(typeof(ConditionData))
//                                     select type).ToArray();
//            }
...
//                        menu.AddItem(new GUIContent(itemName), false, () =>
//                        {
//                            callback?.Invoke((ConditionData)Activator.CreateInstance(type));
//                        });
//                    }
//                }
//            }
